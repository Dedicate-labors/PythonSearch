...
from Metasearch.utils.tools import singleton
...
class MotorBase:
    ...
    def client(self, db):
        #motor
        self.motor_url = 'mongodb://{account}{host}:{port}/{database}'.format(
            ...
            database=db)
        return AsyncIOMotorClient(self.motor_url, io_loop=self.loop)
